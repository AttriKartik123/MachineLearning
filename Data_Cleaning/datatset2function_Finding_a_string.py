...
# as boolean
print('\n')
print(df.salary.str.contains('19', na=False))

# Get the values of entire rows
print('\n')
print(df[df.salary.str.contains('19', na=False)])

# Check For Multiple Expression
print('\n')
print(df.salary.str.contains('19|17', na=False))

# regex = true (same as above, but explicit)
print('\n')
print(df.salary.str.contains('19|17', regex=True, na=False))

# using match (checks only from start of string)
print('\n')
print(df.salary.str.match('19', na=False))
...
print('\n')
print(df[df.quote.str.match('Operative', na=False)])
